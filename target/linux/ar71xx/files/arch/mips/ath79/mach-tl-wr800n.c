/*
 *  TP-LINK TL-WR800N board support
 *
...
#define TL_WR800N_GPIO_LED_SYSTEM	27
#define TL_WR800N_GPIO_BTN_RESET	11

#define TL_WR800N_GPIO_USB_POWER	8
...
static void __init tl_wr800n_setup(void)
{
	...
	ath79_register_leds_gpio(-1, ARRAY_SIZE(tl_wr800n_leds_gpio),
				 tl_wr800n_leds_gpio);
	ath79_register_gpio_keys_polled(-1, TL_WR800N_KEYS_POLL_INTERVAL,
